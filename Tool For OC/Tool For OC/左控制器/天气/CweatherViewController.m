//
//  CweatherViewController.m
//  Tool For OC
//
//  Created by 曹老师 on 2018/5/8.
//  Copyright © 2018年 曹老师. All rights reserved.
//

#import "CweatherViewController.h"
#import "MapManager.h"
...
static CweatherViewController *stanceWeather;

@interface CweatherViewController ()<MapManagerLocationDelegate, UITableViewDelegate, GetWeatherDataDelegate, WeatherViewDelegate, UIViewControllerTransitioningDelegate, FailedLongPressViewDelegate>
...
@implementation CweatherViewController

- (instancetype)init {
    
    if (!stanceWeather) {
        stanceWeather = [super init];
    }
    return stanceWeather;
...
//    closeButton.center = CGPointMake(kScreenWidth * 0.5, kScreenHeight - 60);
...
//    [[UIApplication sharedApplication].keyWindow addSubview:closeButton];
    ...
    // 天气的view
    self.weatherView                     = [[WeatherView alloc] initWithFrame:CGRectMake(0, Nav_Height, kScreenWidth, kScreenHeight - Nav_Height)];
    ...
    // 加载失败后显示的view
    self.failedView          = [[FailedLongPressView alloc] initWithFrame:CGRectMake(0, Nav_Height, kScreenWidth, kScreenHeight - Nav_Height)];
