...
- (void)initTableView {
    ...
    self.tableView            = [[UITableView alloc] initWithFrame:CGRectMake(0, Nav_Height - 64, kScreenWidth, kScreenHeight - (Nav_Height - 64)) style:UITableViewStylePlain];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (section == 0) {
        ...
        ForecastWeatherView *titleView = [[ForecastWeatherView alloc] initWithFrame:CGRectMake(0, 0, Width, 85)];
        [titleView buildView];
        
        titleView.cityName    = self.weatherCondition.city.name;
        titleView.countryCode = self.weatherCondition.city.country;
        
        UIView *line         = [[UIView alloc] initWithFrame:CGRectMake(0, 85 - 1, Width, 0.5)];
