...
// 代理方法
@protocol SelectColorControllerDelegate <NSObject>

@optional
- (void)didSelectColorAction:(UIColor *)selectColor;

@end


// block
typedef void(^didSelectColorBlock)(UIColor *);
...
// 代理
@property (weak, nonatomic) id<SelectColorControllerDelegate> delegate;

// block
@property (copy, nonatomic) didSelectColorBlock colorBlock;
