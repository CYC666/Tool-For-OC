...
//  Tool For OC
//
//  Created by 曹老师 on 2018/5/22.
//  Copyright © 2018年 曹老师. All rights reserved.
//

#import "BlueTalkCtrl.h"
...
@interface BlueTalkCtrl ()<NSStreamDelegate,UITableViewDataSource,UITableViewDelegate,UITextViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,AVAudioRecorderDelegate,AVAudioPlayerDelegate>
{
...
//    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:buttonTitleArray[1] style:UIBarButtonItemStyleDone target:self action:@selector(showSelfAdvertiser)];
    ...
    UIBarButtonItem *rightItem = [[UIBarButtonItem alloc] initWithTitle:@"寻找设备" style:UIBarButtonItemStyleDone target:self action:@selector(lookOtherDevice)];
