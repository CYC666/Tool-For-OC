//
//  YBImageBrowserCtrl.m
//  Tool For OC
//
//  Created by 曹老师 on 2018/5/24.
//  Copyright © 2018年 曹老师. All rights reserved.
//

#import "YBImageBrowserCtrl.h"
...
@interface YBImageBrowserCtrl () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, YBImageBrowserDataSource> {
...
@implementation YBImageBrowserCtrl
...
- (void)A_showWithTouchIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.dataArray0 enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        [model setImageWithFileName:obj fileType:@"jpg"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        NSString *path = [NSString stringWithFormat:@"%@.jpg", self.dataArray0[indexPath.row]];
