...
- (void)initWithRightNavItem {
    UIBarButtonItem *item1 = [[UIBarButtonItem alloc] initWithImage:nil style:UIBarButtonItemStylePlain target:self action:@selector(rightBarButtonClicked:)];
    item1.title = @"重置";
    UIBarButtonItem *item2 = [[UIBarButtonItem alloc] initWithImage:nil style:UIBarButtonItemStylePlain target:self action:@selector(leftBarButtonClicked:)];
    item2.title = @"筛选";
...
- (void)leftBarButtonClicked:(id)sender {
    ...
    [self.filterController showInView:self.navigationController.view];
}
